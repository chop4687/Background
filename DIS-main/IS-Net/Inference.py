...
if __name__ == "__main__":
    dataset_path="C:/Users/HP/Desktop/python/background/DANCE/sample_png/"  #Your dataset path
    model_path="../saved_models/isnet-general-use.pth"  # the model path
    result_path="C:/Users/HP/Desktop/python/background/DANCE/Dance_result/"  #The folder path that you want to save the results
